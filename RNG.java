...
public class RNG {
	 ...
	 * @param nextGuess is the guess entered by the user
	 * @param lowGuess is the lowest number being lower than the random number
	 * @param highGuess is the highest number being greater than the random number
	 * @return rtnValue a boolean, true if the guess is with the bounds, false otherwise
	 */
